...
public class CameraHelper implements Camera.PreviewCallback {
    ...
    private boolean isRlMirror = false;
    private boolean isUdpMirror = false;
    ...
    private CameraHelper(Builder builder) {
        ...
        if (builder.previewDisplayView instanceof TextureView) {
            isRlMirror = builder.isRlMirror;
            isUdpMirror = builder.isUdMirror;
        } else if (isRlMirror) {
    ...
    public void init() {
        ...
        if (isUdpMirror) {
            previewDisplayView.setScaleY(-1);
        }
    }
        ...
        synchronized (this) {
            ...
            if (mCameraId == -1) {
                if (cameraListener != null) {
                    cameraListener.onCameraError(new Exception("com.mind.face.camera not found"));
                }
                return;
            }
            if (mCamera == null) {
            ...
            try {
                ...
                Log.e(TAG, "设置相机预览大小:" + CAMERA_PREVIEW_WIDTH + "==========" + CAMERA_PREVIEW_HEIGHT);
                ...
                if (cameraListener != null) {
                    cameraListener.onCameraOpened(mCamera, mCameraId, displayOrientation, isRlMirror);
                }
...
//            start();
    ...
    public static final class Builder {
         ...
         */
        private boolean isRlMirror;
        private boolean isUdMirror;
        /**
         * 指定的相机ID
         */
        ...
        public Builder isUdMirror(boolean val) {
            isUdMirror = val;
            return this;
        }
